---
name: designer
description: UI/UX design, review, and implementation specialist. Use PROACTIVELY for any user-facing interface work - styling, responsive design, component architecture, animations/micro-interactions, visual polish, and UX review. Routes all layout, hierarchy, and interaction decisions; not for headless/backend work.
